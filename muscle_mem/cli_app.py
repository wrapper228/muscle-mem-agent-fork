...
def main():
    ...
    parser.add_argument(
        "--image_ground_provider",
        type=str,
        default=None,
        help="Optional provider for click_image_area grounding model",
    )
    parser.add_argument(
        "--image_ground_url",
        type=str,
        default=None,
        help="Optional URL for click_image_area grounding model",
    )
    parser.add_argument(
        "--image_ground_api_key",
        type=str,
        default=None,
        help="Optional API key for click_image_area grounding model",
    )
    parser.add_argument(
        "--image_ground_model",
        type=str,
    ...
    engine_params_for_image_grounding = None
    if any(
        value is not None
        for value in (
            args.image_ground_provider,
            args.image_ground_url,
            args.image_ground_api_key,
            args.image_ground_model,
        )
    ):
        engine_params_for_image_grounding = dict(engine_params_for_grounding)
        if args.image_ground_provider is not None:
            engine_params_for_image_grounding["engine_type"] = (
                args.image_ground_provider
            )
        if args.image_ground_model is not None:
            engine_params_for_image_grounding["model"] = args.image_ground_model
        if args.image_ground_url is not None:
            engine_params_for_image_grounding["base_url"] = args.image_ground_url
        if args.image_ground_api_key is not None:
            engine_params_for_image_grounding["api_key"] = args.image_ground_api_key
    ...
    grounding_agent = OSWorldACI(
        ...
        engine_params_for_image_grounding=engine_params_for_image_grounding,
        width=screen_width,
